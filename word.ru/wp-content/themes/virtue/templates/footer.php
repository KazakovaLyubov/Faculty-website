  ...
  <div class="container">
  	<div class="row">
        ...
        <div class="footercredits clearfix">
        	...
        	<p><?php if(isset($virtue['footer_text'])) { $footertext = $virtue['footer_text'];} else {$footertext = '[copyright] [the-year] [site-name] [theme-credit]';} echo do_shortcode($footertext); ?> - <a href="http://best-wordpress-templates.ru/">Шаблоны WordPress</a></p>
    	</div>
